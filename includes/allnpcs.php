...
$npc_cols[0] = array('name', 'subname','chinese', 'chineseSub', 'minlevel', 'maxlevel', 'Creaturetype', 'rank', 'FactionAlliance', 'FactionHorde');
...
function creatureinfo2(&$Row) {
    ...
    $creature['chinese'] = !empty($Row['chinese']) ? $Row['chinese'] : $Row['name'];
    // Подимя создания
    $creature['subname'] = !empty($Row['subname_loc']) ? $Row['subname_loc'] : $Row['chineseSub'];
    // Min/Max уровни
