        ...
        for (var X = 0, e = V.length; X < e; ++X) {
            if (V[X][0] == null) {
                ...
                if (V[X][5] != null) {
                    ...
                    F.style.backgroundImage = "url(images/icons/small/" + V[X][5].toLowerCase() + ".png)";
                    if (V[X].checked) {
                        var K = ce("span");
    ...
    item: {
        ...
        columns: [{
            ...
            compute: function (D, G, E) {
                ...
                var AA = ce("a");
                AA.className = "q" + (6 - parseInt(D.name.charAt(0)));
                AA.style.fontFamily = "Verdana, sans-serif";
                AA.href = this.template.getItemLink(D);
                ae(AA, ct(D.chinese));
                var AAText = ce("span");
                AAText.innerHTML='中文：';
                ae(G, AAText);
            ...
            compute: function (C, D) {
                ...
                A.href = B;
                ae(A, ct(typeof Listview.funcBox.getItemType(C.classs, C.subclass, C.subsubclass) !='undefined' ?  Listview.funcBox.getItemType(C.classs, C.subclass, C.subsubclass) : ''));
                ae(D, A)
            },
    ...
    npc: {
        ...
        columns: [{
            ...
            compute: function (B, C) {
                ...
                var A = ce("a");
                A.href = "?npcs=" + B.type;
                ae(A, ct(typeof g_npc_types[B.type] != 'undefined' ? g_npc_types[B.type] : ''));
                ae(C, A)
            },
            sortFunc: function (B, A, C) {
    ...
    object: {
        ...
        columns: [{
            ...
            compute: function (B, C) {
                ...
                ae(A, ct(typeof g_object_types[B.type] != 'undefined' ? g_object_types[B.type] : ''));
                ae(C, A)
            },
            sortFunc: function (B, A, C) {
        ...
        columns: [{
            ...
            compute: function (B, C) {
                if (B.category != 0) {
                    ...
                    ae(A, ct(typeof Listview.funcBox.getQuestCategory(B.category) != 'undefined' ? Listview.funcBox.getQuestCategory(B.category) : ''));
                    ae(C, A)
                }
            },
            sortFunc: function (B, A, D) {
    ...
    spell: {
        ...
        columns: [{
            ...
            compute: function (F, C, J) {
                ...
                if (I != "@") {
                    LL.className = "q" + (6 - parseInt(I))
                }
                LL.style.fontFamily = "Verdana, sans-serif";
                LL.href = this.template.getItemLink(F);
                ae(LL, ct(F.chinese ? F.chinese : '无'));
                var LAText = ce("span");
                LAText.innerHTML='中文：';
                ae(A, LAText);
                ae(A, LL);
