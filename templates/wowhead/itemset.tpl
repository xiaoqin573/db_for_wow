			...
			<div id="main-contents" class="main-contents">
				...
				<div class="text">
			         <div class="textnewh1tit">
                         <h1>{$itemset.chinese}</h1>
                         <p class="ywming"><span>英文名：</span>{$itemset.name}&nbsp;&nbsp;&nbsp;<a href="#">复制</a></p>
                            <p class="daimafuzhi">
					...
					<table class="iconlist">
						{section name=i loop=$itemset.pieces}<tr><th align="right" id="iconlist-icon{$smarty.section.i.index+1}"></th><td><span class="q{$itemset.pieces[i].quality}"><a href="?item={$itemset.pieces[i].entry}">{$itemset.pieces[i].chinese}（{$itemset.pieces[i].name}）</a></span></td></tr>{/section} 
					</table>
					<script type="text/javascript">
