		...
		<div id="main">
			...
			<div id="main-contents" class="main-contents">
				...
				<div class="text">
                    ...
                    <h1>{$item.chinese}</h1>
                    <p class="ywming">
                        <span>英文名：</span>{$item.name} &nbsp;&nbsp;&nbsp;<a href="#">复制</a>
                    </p>
                    <p class="daimafuzhi">
					...
					<div id="tooltip{$item.entry}-generic" class="tooltip2" style="float: left; padding-top: 1px">
					...
					<script type="text/javascript">
						ge('icon{$item.entry}-generic').appendChild(Icon.create('{$item.iconname|strtolower|trim}', 2, 0, 0, {$item.stackable}));
