...
if (1) {
    ...
    $row = $DB->selectRow('
			SELECT factionID,chinese,chinese_desc, name_loc' . $_SESSION['locale'] . ', description1_loc' . $_SESSION['locale'] . ', description2_loc' . $_SESSION['locale'] . ', team, side
    ...
    if ($row) {
        ...
        $faction['chinese'] = $row['chinese'];
        $faction['chinese_desc'] = $row['chinese_desc'];
